...
- HTTP/1.1 makes connection lifetime stateful across multiple requests -> Mitigation: audit all handler response paths for `Content-Length` and add regression tests.
